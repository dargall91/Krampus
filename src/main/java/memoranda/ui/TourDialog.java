...
public class NewTourDialog extends JDialog implements WindowListener {	
    ...
    public JComboBox routeCB = new JComboBox(routes);
    
    
    public NewTourDialog(Frame frame, String title) {
    ...
    void jbInit() throws Exception {
        ...
        header.setText(Local.getString("Tour"));
