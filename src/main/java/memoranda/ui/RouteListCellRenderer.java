 ...
 *
 * <p>References:
 * //https://stackoverflow.com/questions/20155122/is-there-any-way-to-add-objects-to-a-jcombobox
 * -and-assign-a-string-to-be-shown
 */
public class RouteListCellRenderer extends DefaultListCellRenderer {
     ...
     * @param isSelected   whether is selected
     * @param cellHasFocus whether has focus
     * @return Component
     */
