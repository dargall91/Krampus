...
/**
 * Node object representing a node ("bus stop") in the MTB scheduling system.  Nodes have
 * coordinates and can be associated with routes.
 *
 * @author Brian Pape
 * @version 2021-04-01
 */
public class Node extends IndexedObject {
    ...
    public Node(@JsonProperty("id") int id, @JsonProperty("name") String name,
                @JsonProperty("lat") Double lat, @JsonProperty("lon") Double lon) {
        super(id);
        this.name = name;
    ...
    /*
    The input file for the system will be in json format with specific key/value pairs that
    define the following, defined as “nodes”:
    ...
    AC2: Data are exposed in a manner accessible to the application through an object with a
    defined interface.
     */
}
